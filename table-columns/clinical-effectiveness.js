...
// Models
import { deleteCE } from '../models/clinical-effectiveness';
const columns = (apiRef) => {
  ...
  const handleDeleteClick = (id) => (event) => {
    ...
    const deleted = deleteCE(id);
    if (deleted.error) {
      enqueueSnackbar('Something went wrong, Please try again!', { variant: 'error' });
    } else {
      apiRef.current.updateRows([{ id, _action: 'delete' }]);
      enqueueSnackbar('Clinical Effectiveness deleted Successfully!', { variant: 'success' });
    }
  };
